...
namespace tf2
{
                       ...
                       const std::string& child_frame_id)
  {
    ...
    msg.transform.translation.x = tf2.getOrigin().getX();
    msg.transform.translation.y = tf2.getOrigin().getY();
    msg.transform.translation.z = tf2.getOrigin().getZ();
    msg.transform.rotation.x = tf2.getRotation().getX();
    msg.transform.rotation.y = tf2.getRotation().getY();
    msg.transform.rotation.z = tf2.getRotation().getZ();
    msg.transform.rotation.w = tf2.getRotation().getW();
  }
}
